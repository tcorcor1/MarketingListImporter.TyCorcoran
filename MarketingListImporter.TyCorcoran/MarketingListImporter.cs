...
namespace MarketingListImporter.TyCorcoran
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Dynamics Marketing - Marketing List Importer"),
        ExportMetadata("Description", "Import a CSV of Leads or Contacts into your existing marketing or subscription lists. Includes Contact/Lead deduplication and parent Account hierarchy support."),
    ...
    public class MarketingListImporter : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new MarketingListImporterControl();
        }

        /// <summary>
        /// Constructor 
        /// </summary>
        public MarketingListImporter()
        {
